...
SOURCEFILES_QUOTED_IF_SPACED=ejercicio_3.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ejercicio_3.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ejercicio_3.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ejercicio_3.o

# Source Files
SOURCEFILES=ejercicio_3.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/ejercicio_3.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/ejercicio_3.o: ejercicio_3.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ejercicio_3.o 
	${MP_AS} -mcpu=PIC18F57Q43 -c \
	-o ${OBJECTDIR}/ejercicio_3.o \
	ejercicio_3.s \
...
${DISTDIR}/ejercicio_3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/ejercicio_3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
