# 1 "encender_apagar_led_con_pulsador.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "encender_apagar_led_con_pulsador.s" 2
...
# 5 "encender_apagar_led_con_pulsador.s" 2
...
; CONFIG1
  CONFIG FEXTOSC = XT ; External Oscillator Selection (XT (crystal oscillator) above 100 kHz, below 8 MHz)
...
# 7 "encender_apagar_led_con_pulsador.s" 2
 ...
 movlb 04H
 ;PINES DE ENTRADA
 bsf TRISF, 3, b ; pin ((PORTF) and 0FFh), 3, a como entrada (0 SALIDA, 1 ENTRADA)
 bcf ANSELF, 3, b ; digital -> ( 0 digital, 1 analogico)

 ; PINES SALIDA
 bcf TRISD, 3, b ; ((PORTD) and 0FFh), 3, a salida
 ...
 goto espera_suelto ; si el boton esta presionado
    ...
    ; 4) Espera a que SUELTEN (((PORTF) and 0FFh), 3, a = 0) para evitar múltiples toggles por rebote
    espera_liberacion:
        btfsc PORTF, 3, b ; si ((PORTF) and 0FFh), 3, a=1, sigue esperando liberación
