# 1 "encender_led_pulsador.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "encender_led_pulsador.s" 2
...
configuro:
    ...
    bsf TRISD,3 ; el ((PORTD) and 0FFh), 3, a en entrada
    bcf ANSELD,3, b ;((PORTD) and 0FFh), 3, a digital
...
suelto:
    ...
    ; PORTD -> vamos a leer el valor del puerto ((PORTD) and 0FFh), 3, a
    goto suelto
presionado:
    ...
    bsf LATF,3, b ; ponemos el ((PORTF) and 0FFh), 3, a en 1 , osea va entregar 5v
    goto inicio
    end
