...
; CONFIG5
  ...
  CONFIG WDTE = ON ; WDT operating mode (WDT enabled regardless of sleep; ((WDTCON0) and 0FFh), 0, b is ignored)
...
ORG 20 ; aqui termina el salto
 ...
 configuro:
    ...
    clrf TRISD,b ; VAMOS A TRABAJAR CON EL PUERTO D ((PCON0) and 0FFh), 1, a ESO PONEMOS AL FINAL LA D
...
inicio: ; es la etiqueta que le damos para iniciar toedo
    ...
    movwf LATD, b ; este dato se envia al puerto D osea en el puerto de desde puerto D0 hasta el D7 va a salir el numero 04 que es 0000 0100, osea el ((PORTD) and 0FFh), 2, a va estar en 1
    CALL retardo
